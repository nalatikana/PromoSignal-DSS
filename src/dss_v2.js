...
<section class="pane" id="p-iv">
  ...
  <h2 class="sechead">เรตติ้ง คะแนนเติบโต และความอ่อนไหว</h2>
  <p class="secsub">ให้เรตติ้ง A–E กับหลักทรัพย์ในรายการเฝ้าดู จากค่าคาดการณ์นวัตกรรมเปิดของโมเดล พร้อมบอกว่าถ้าโครงสร้างคณะกรรมการขยับ ค่าคาดการณ์จะขยับตามเท่าไหร่ — ใช้เป็นตัวคัดกรองขั้นต้น ไม่ใช่คำแนะนำการลงทุน</p>

  <div class="card" style="margin-bottom:14px">
    <div class="btnrow">
      <button class="btn p" id="btnSeedInv">＋ เพิ่มตัวอย่าง 6 หลักทรัพย์</button>
...
<section class="pane" id="p-dm">
  ...
  <div class="card"><h3>4 · ตัวติดตามข้อมูลตรวจสอบ</h3>
...
function bootV2() {
  ...
  nav.innerHTML = "";
  wanted.forEach(([p, el]) => { if (el) { el.onclick = () => go(p); nav.appendChild(el); } });
