...
<section class="pane" id="p-guide">
  ...
  <h2 class="sechead">เริ่มใช้ระบบนี้แบบไม่งง</h2>
  <p class="secsub">เลือกงานที่ต้องการก่อน แล้วทำตาม 3 ขั้นตอนด้านล่าง ระบบนี้มีสองงานหลัก: ประเมินองค์กรจากเอกสาร และคัดหุ้นนวัตกรรมจากคะแนน/ผล backtest</p>

  <div class="guideHero">
    <div>
      <span class="guideBadge">งานที่ 1</span>
      <h3>ประเมินองค์กร</h3>
      <p>ใช้เมื่อมีรายงานประจำปีหรือข้อความผู้บริหาร แล้วต้องการดูว่าโครงสร้างบอร์ดและภาษาผู้บริหารสัมพันธ์กับนวัตกรรมเปิดอย่างไร</p>
      <button class="btn p" id="btnGuideOrg">ไปประเมินองค์กร</button>
    </div>
    <div>
      <span class="guideBadge">งานที่ 2</span>
      <h3>คัดหุ้นลงทุน</h3>
      <p>ใช้เมื่ออยากจัดอันดับ SET100 ด้วย Innovation Alpha Score, ตรวจ Top 10 เทียบ SET Index, และหา Top 5 ล่าสุดเพื่อตรวจต่อ</p>
      <button class="btn p" id="btnGuideInv">ไปคัดหุ้นลงทุน</button>
    </div>
  </div>

  <div class="guideSteps">
    <div class="guideStep"><b>1</b><h3>ใส่ข้อมูล</h3><p>อัปโหลดเอกสาร หรือเตรียม CSV สำหรับ Python pipeline ตาม template ในหน้า ข้อมูลและโมเดล</p></div>
    <div class="guideStep"><b>2</b><h3>ดูคะแนน</h3><p>ดูค่าคาดการณ์, percentile, Innovation Alpha Score และ sensitivity ว่าตัวแปรไหนทำให้ผลเปลี่ยนมาก</p></div>
    <div class="guideStep"><b>3</b><h3>ตรวจผลก่อนใช้</h3><p>ดู backtest, ข้อจำกัด, และส่งออกรายงาน พร้อมระบุเสมอว่าไม่ใช่คำแนะนำลงทุนหรือความสัมพันธ์เชิงสาเหตุ</p></div>
  </div>
  ...
  <div class="grid g2" style="margin-top:16px">
    <div class="card">
      ...
      <div class="readList">
        <div><b>Innovation Alpha Score</b><span>คะแนน 0-100 ยิ่งสูงยิ่งอยู่ลำดับบนเมื่อเทียบกับ universe ที่ใช้</span></div>
        <div><b>Backtest Top 10</b><span>ทดสอบว่าซื้อหุ้นคะแนนสูงสุด 10 ตัวรายไตรมาส ชนะ SET Index หรือไม่</span></div>
        <div><b>Top 5 ล่าสุด</b><span>รายชื่อสำหรับตรวจต่อ ไม่ใช่คำสั่งซื้อขาย ต้องดูข่าว งบ สภาพคล่อง และราคาอีกครั้ง</span></div>
      </div>
    </div>
    <div class="card">
      <h3>คำที่ควรใช้ตอนนำเสนอ</h3>
      <div class="note info"><b>ประโยคสั้น ๆ</b><br>ระบบนี้เป็น prototype เพื่อจัดอันดับและทดสอบสมมติฐานว่า “บริษัทที่มีสัญญาณนวัตกรรมสูง” สามารถสร้าง alpha เทียบ SET Index ได้หรือไม่</div>
      <div class="note warn" style="margin-top:10px"><b>ประโยคข้อจำกัด</b><br>คะแนนเป็นสัญญาณเชิงสถิติจากข้อมูลย้อนหลังและข้อความสาธารณะ ไม่ใช่คำแนะนำลงทุน และไม่ยืนยันเหตุและผล</div>
    </div>
  </div>
</section>
...
<section class="pane" id="p-howto">
  ...
  <div class="checkGrid">
    ...
    <div class="card"><h3>สิ่งที่ระบบต้องแสดง</h3>
      <label class="check"><input type="checkbox"> Innovation Alpha Score 0-100</label>
      <label class="check"><input type="checkbox"> Top 10 backtest เทียบ SET Index</label>
      <label class="check"><input type="checkbox"> Equity curve และ alpha รวม</label>
      <label class="check"><input type="checkbox"> Top 5 ล่าสุดสำหรับ operational validation</label>
    </div>
  ...
  <div class="card" style="margin-top:16px">
    ...
    <ol class="demoFlow">
      <li><b>เปิด คู่มือใช้งาน</b> อธิบายว่าระบบมี 2 งาน: ประเมินองค์กร และคัดหุ้นลงทุน</li>
      <li><b>ไป คัดหุ้นลงทุน → Innovation Alpha Score</b> แสดงว่าคะแนนเรียงลำดับหุ้นได้</li>
      <li><b>ไป Backtest เทียบ SET</b> อธิบายว่าพอร์ต Top 10 ชนะ/แพ้ SET Index อย่างไร</li>
      <li><b>ไป Top 5 ล่าสุด</b> แสดง shortlist สำหรับทดลองในสภาพแวดล้อมจริง</li>
      <li><b>จบที่ ข้อมูลและโมเดล</b> แสดง Python pipeline และ template CSV เพื่อพิสูจน์ว่าทำซ้ำได้</li>
    </ol>
  </div>
</section>`;
